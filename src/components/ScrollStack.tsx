...
const ScrollStack: React.FC<ScrollStackProps> = ({
  ...
  const updateCardTransforms = useCallback((customScrollTop?: number) => {
    ...
    const scrollTop = typeof customScrollTop === 'number' ? customScrollTop : scrollData.scrollTop;
    ...
    cardsRef.current.forEach((card, i) => {
      ...
      const effectiveEndTop = endElementTop > cardTop ? endElementTop : cardTop + 600;
      const pinEnd = Math.max(pinStart + 100, effectiveEndTop - containerHeight / 2);
  ...
  const handleScroll = useCallback((e?: any) => {
    const sTop = typeof e?.scroll === 'number' ? e.scroll : undefined;
    updateCardTransforms(sTop);
