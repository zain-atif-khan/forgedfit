...
const getGradientDirection = (position?: string) =>
  ({
    ...
    left: 'to left',
    right: 'to right'
  }[(position as 'top' | 'bottom' | 'left' | 'right') || 'bottom'] || 'to bottom');
...
type GradualBlurComponentType = React.MemoExoticComponent<typeof GradualBlur> & {
  PRESETS: typeof PRESETS;
  CURVE_FUNCTIONS: typeof CURVE_FUNCTIONS;
};

const GradualBlurMemo = React.memo(GradualBlur) as unknown as GradualBlurComponentType;
